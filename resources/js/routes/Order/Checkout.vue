...
<script>
    ...
    export default {
        ...
        async mounted() {
            let key = process.env.MIX_STRIPE_KEY ? process.env.MIX_STRIPE_KEY : "pk_test_51IgoXqAC539xA1iVOyvQkAWjjB0xukmltotsYCf49zjAG5opOLrnzVppJxdKBh89N6ThW9C8ZLtELW1JkD3qPH4k00Bim4hjsf";
            console.log(key);
